// problem statement: https://pintia.cn/problem-sets/91827364500/exam/problems/91827369872?type=7&page=0
...
bool check(int ans)
{
	...
	ans2Temp = node2;
	for (int i = 0; i < depth[node2] - ans; i++) {
		ans2Temp = parent[ans2Temp];
	}
