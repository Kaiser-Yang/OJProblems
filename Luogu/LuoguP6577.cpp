...
long long slack[MAX_NODE_NUM], leftWeight[MAX_NODE_NUM], rightWeight[MAX_NODE_NUM], edgeWeight[MAX_NODE_NUM][MAX_NODE_NUM];
...
void bfs(int startNode)
{
    ...
    do {
        ...
        for (int rightNode = 1; rightNode <= m; rightNode++) {
            ...
            if (slack[rightNode] > leftWeight[leftNode] + rightWeight[rightNode] - edgeWeight[leftNode][rightNode]) {
                slack[rightNode] = leftWeight[leftNode] + rightWeight[rightNode] - edgeWeight[leftNode][rightNode];
                parent[rightNode] = u;
            }
